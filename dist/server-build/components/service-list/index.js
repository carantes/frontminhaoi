      ...
      <ul className="form__items">
          ...
          <li className="form__item">
            <div className="form__item__icon conta-desk">
              <Isvg src="/assets/icons/form/conta-desk.7fb941fe.svg" />
            </div>
            <div className="form__item__data">
          ...
          <li className="form__item">
            <div className="form__item__icon instalacao-desk">
              <Isvg src="/assets/icons/form/instalacao-desk.f2a32ffd.svg" />
            </div>
            <div className="form__item__data">
          ...
          <li className="form__item">
            <div className="form__item__icon recarga-desk">
              <Isvg src="/assets/icons/form/recarga-desk.f2b8ca00.svg" />
            </div>
            <div className="form__item__data">
              <h2>Recarga</h2>
          ...
          <li className="form__item">
            <div className="form__item__icon duvidas-desk">
              <Isvg src="/assets/icons/form/duvidas-desk.edb91657.svg" />
            </div>
            <div className="form__item__data">
          ...
          <li className="form__item">
            <div className="form__item__icon fale">
              <Isvg src="/assets/icons/form/fale-desk.4529e100.svg" />
            </div>
            <div className="form__item__data">
              <h2>Fale com a Oi</h2>
